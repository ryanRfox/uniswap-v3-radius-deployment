...
// Configuration
const RADIUS_RPC = 'https://rpc.testnet.tryradi.us/rn2ikraqjcsevlh7g37y6aud8x7b3dkuacitzxrv8730pfvg';
...
async function testRadiusNonceBug() {
  ...
  try {
    ...
    console.log('============================================================');
    console.log('');
    console.log('If nonce errors occurred:');
    console.log('1️⃣  Use Radius deployment (includes workarounds):');
    console.log('    npm run deploy');
    console.log('');
    console.log('2️⃣  Try Radius Staging (should be bug-free):');
    console.log('    npm run switch-to-radius-staging');
    console.log('    npm run test-staging-nonce');
    console.log('');
    console.log('If tests passed (bug is fixed):');
    console.log('🎉 Bug has been fixed! You can use vanilla deployment.');
    console.log('');
